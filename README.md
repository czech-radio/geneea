    ...
    "paragraphs": [
      {
        "id": "p0",
        "type": "BODY",
        "text": "Populární známka se prodávala na jediném místě v centru Kyjeva, kde na ni každý den čekaly stovky lidí. Mezitím se arch šesti známek prodává na inzertních serverech za více než 10 tisíc korun.",
        "sentences": [
          {
            "id": "s0",
            "tokens": [
